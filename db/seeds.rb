...
Tweet.create(title: "八戸学院光星、壮絶な打撃戦を制す",round: "2回戦",text: "八戸学院光星が練習試合で2度負けている智弁学園に勝利。壮絶な打撃戦を制した中でも光った横山、山田の2投手。横山は左投手には珍しく、三塁側に立って投げることにより、右打者のチェンジアップがかなり効いており、高めのストレートでも空振りを奪うことができており、ピッチングの幅も広い。また2番手としてマウンドに登ったエースの山田 怜卓も初戦と比べても力が入っていた。コンスタントに常時140キロ～143キロのストレートを投げ込み、自己最速タイの145キロを計測。",
             school_a_score: "10",school_b_score: "8",school_a_id: 37,school_b_id: 65,tournament_id: 34,user_id: 2)
...
Tweet.create(title: "星稜、投打で圧倒し、24年ぶりの決勝進出！",round: "準決勝",text: "星稜の奥川 恭伸が5回まで無失点の好投を見せている。1回表、先頭打者に安打を浴びたが、後続をしっかりと締めると、2回以降は最速153キロ・常時145キロ～150キロの直球、130キロ前半のスライダー、130キロ前後のチェンジアップを織り交ぜ、7回まで投げて10奪三振、2安打、無四球、無失点の快投を見せた。こうして中京学院大中京を圧倒した星稜。奥川以外の投手陣の成長が奥川の負担を減らし、準決勝でも精度が高いピッチングを見せることができている。",
             school_a_score: "9",school_b_score: "0",school_a_id: 59,school_b_id: 54,tournament_id: 34,user_id: 4)
...
Tweet.create(title: "智辯和歌山がビッグイニングで逆転",round: "2回戦",text: "1点を追いかける7回、1イニング3ホームランで打線が大爆発し逆転勝利！今大会屈指の強力打線と言える。智辯和歌山の先発・矢田 真那斗（2年）が粘り強い投球を見せた。インステップ気味に踏み出して、振りだす左のスリークォーター。常時125キロ～130キロ台のストレートを両サイドに投げ分け、110キロ台のチェンジアップ、カーブを低めに集める投球だった。",
             school_a_score: "9",school_b_score: "0",school_a_id: 59,school_b_id: 54,tournament_id: 34,user_id: 2)
...
Tweet.create(title: "リズムに乗った倉敷商が仙台育英を下す！",round: "1回戦",text: "5回、後攻の倉敷商は一死満塁から3番・浅野大器が押し出しの四球を選び勝ち越し。2対1と仙台育英から一歩リードする。さらに4回途中からマウンドに上がっていた倉敷商のエース・永野 司の好投からリズムを作り、5回にも1点を追加する。こうすると倉敷商の勢いが止まらず6回には8番・永野のタイムリーで3対1。そして7回には7番・田村のタイムリーなどで6対1。一気に試合を決定づけた倉敷商が6対1で仙台育英を下した。",
             school_a_score: "6",school_b_score: "1",school_a_id: 105,school_b_id: 86,tournament_id: 84,user_id: 3)
...
Tweet.create(title: "注目対決は大阪桐蔭に軍配",round: "1回戦",text: "まさに激闘、死闘だといってもいい実力の拮抗した一戦だった。2018年に春夏連覇した大阪桐蔭。対するはアグレッシブベースボールを掲げ、2015年に日本一に輝いた東海大相模。東西の超名門が激突した。後半にゲームが大きく動き大阪桐蔭が辛勝！",
             school_a_score: "4",school_b_score: "2",school_a_id: 100,school_b_id: 91,tournament_id: 84,user_id: 2)
...
Tweet.create(title: "東邦が個人力、組織力で圧倒し30年ぶりの全国制覇！",round: "決勝",text: "試合巧者の習志野の上をいく個人力と組織プレーが光った決勝戦だった。まず東邦は1回裏、3番・石川昂弥がバックスクリーンへ2ランを放ち、2点を先制する。さらに打撃好調の吉納翼の適時三塁打も飛び出し3点目を入れる。これまで数多くの好投手を攻略してきた習志野だが、制球力抜群の石川を攻略できなかった。またバントミス、走塁ミスも多かった。そしてヒット性の打球を巧みに裁く東邦の守備陣。石川もバント処理を軽快に裁き、投ゴロバント併殺がなんと2つ。着実に習志野を追い詰めていった。そして5回裏、再び石川。エース・飯塚 脩人が投じたスライダーを逃さず、本塁打を放つ。石川は連投となっても制球力が落ちる気配が見られない。内野手の堅い守備とポジショニングの良い守備が光った。シフトをしっかりと敷いてもその狙い通りにアウトにとれたのは内野手の硬い守備や石川の制球力の高さが生きている。最後まで安定した試合運びを続け、東邦が30年ぶりの優勝を決めた。",
             school_a_score: "6",school_b_score: "0",school_a_id: 12,school_b_id: 7,tournament_id: 1,user_id: 4)
...
Tweet.create(title: "継投が裏目に出た「神宮王者」",round: "２回戦",text: "札幌大谷の先発マウンドに登ったのは、背番号18を背負った身長197センチの左腕・阿部 剣友。球速こそ常時130キロ台前半であったが、197センチの身長から振り下ろすフォームは見るからに打ちづらそうで、1回戦で横浜投手陣を打ち崩した明豊打線を抑え込んでいく。5回に継投策に出た札幌大谷。だが、結果的にこの継投は裏目に出ることになった。太田は、その後二塁に進塁を許して二死二塁とすると、4番・野邊 優汰が右中間を真っ二つに破るタイムリースリーベースを浴び、先制点を許す。さらに5回裏、明豊の6番・山田 昭太のツーベースから一死三塁のピンチを招いた札幌大谷は、8番・若杉にセンター前タイムリーを浴び、決勝点を奪われ敗退。",
             school_a_score: "2",school_b_score: "1",school_a_id: 28,school_b_id: 2,tournament_id: 1,user_id: 2)
...
Tweet.create(title: "21世紀枠最強の東播磨が大健闘",round: "1回戦",text: "強豪・明豊の歯車狂わせた東播磨の走力に称賛の声続出！敗れはしましたが10-9の大健闘。夏もぜひ見てみたいチームです！",
             school_a_score: "1",school_b_score: "0",school_a_id: 144,school_b_id: 148,tournament_id: 117,user_id: 3)

Tweet.create(title: "名門同士の試合は思わぬ大差",round: "2回戦",text: "中京大中京が打力で圧倒し常総学院を下す。常総のWエースがここまで打たれるとは思ってもいませんでした。",
             school_a_score: "15",school_b_score: "5",school_a_id: 127,school_b_id: 122,tournament_id: 117,user_id: 2)
...
Tweet.create(title: "石田投手が圧巻のピッチング",round: "準決勝",text: "東海大相模のエース石田が被安打3で、2試合連続完封。130キロ台後半の直球とスライダーをコースに投げ分け、三回1死から6者連続三振を奪うなど、計15奪三振。六回に1死三塁のピンチを招いたが、それまであまり投げていなかったチェンジアップを織り交ぜて切り抜けた。今大会初先発の天理の左腕、仲川は一回こそ球が浮いて3安打を浴びたが、二回以降は変化球が低めに決まりだし、八回まで粘投した。だが、準々決勝までの3試合で21得点の打線が、最後まで石田の速球を攻略できなかった。",
             school_a_score: "2",school_b_score: "0",school_a_id: 125,school_b_id: 136,tournament_id: 117,user_id: 4)

Tweet.create(title: "ミスに乗じた明徳義塾がサヨナラ勝ち、雨で揺らいだ県立岐阜商",round: "1回戦",text: "試合は5回まで0点の試合展開だったが、6回に明徳義塾先発・代木 大和が2番・梅村 豪に死球を与えると、3番・松野 匠馬に右中間を破られるタイムリーで先取点を許してしまう。なおも無死三塁とピンチが続くが、ここで馬淵監督は「継投は脳裏にあった」と言うことで準備ができていた2番手・吉村 優聖歩がマウンドに上がる。さらなる失点も覚悟したが、後続のバッターを内野ゴロなど3人で抑えて、ピンチを脱すると、攻撃に勢いが出てくる。その裏だ。3番・森松 幸亮の二塁打で同点のチャンスを作ると、4番・加藤 愛己の三塁打で同点に追いつく。さらに5番・代木の犠牲フライで2点目と畳みかけるような攻撃で2対1とした。8回に1点を失い、2対2の同点とされたが、9回は一死から1番・米崎 薫暉が四球を選ぶ。送りバントで二死二塁とすると、3番・森山がセンターの頭上を越すサヨナラ打で、明徳義塾が勝利を手にした。",
             school_a_score: "3",school_b_score: "2",school_a_id: 191,school_b_id: 170,tournament_id: 150,user_id: 1)

Tweet.create(title: "これが野球の怖さ",round: "1回戦",text: "4回まで互いに0点の中で、広島新庄が5回に8番・河野 優輝のタイムリーで先取点を奪うことに成功する。追いかける横浜は8回、先頭の1番・緒方 漣がファーストストライクを打ってショートゴロに倒れるも、3番・金井 慎之介のヒットなどで二死一、二塁のチャンスを作った。しかしここは広島新庄2番手・西井 拓大に抑えられ相手が勢いづくと、逆に9回表、広島新庄に1点を追加された。2対0と後が無くなった横浜だが、6番・岸本 一心と7番・玉城 陽希の連打などで二死一、三塁にする。ここで1番・緒方がまたもファーストストライクを捉えると、打球がレフトスタンドに届くサヨナラホームラン。ルーキーの大仕事で横浜が広島新庄を下した。たった１発での大逆転サヨナラ、これが野球の怖さである",
             school_a_score: "3",school_b_score: "2",school_a_id: 166,school_b_id: 184,tournament_id: 150,user_id: 1)

Tweet.create(title: "「らしくなく」ミスに泣いた作新学院",round: "1回戦",text: "0対0で迎えた3回、高松商は先頭の徳田 叶夢がヒットで出塁するなど、一死一、三塁とすると、2番・浅野が先制タイムリーを放ち、高松商に先制点が入る。さらに3番・安藤 康城のレフト前に相手のミスでチャンスを広げたところで、4番・藤井 陸斗のファーストゴロで追加点を奪った。5回には相手バッテリーのミスや、4番・藤井の2本目のタイムリーで3点を追加して6対1とリードを広げる。5点リードをもらった高松商先発・徳田は6回途中で渡辺 和大にバトンタッチをするが、作新学院の8番・渡辺 翔偉の一打で一時同点に追いつかれた。それでも8回に先頭バッターが相手のエラーで出るなど二死満塁で、4番・藤井の走者一掃のタイムリーで試合を決めた。最後は3番手・坂中 大貴が作新学院の猛追に遭うものの、10対7で勝利して3回戦進出。同時に4元号での甲子園勝利を掴むことになった。",
             school_a_score: "10",school_b_score: "7",school_a_id: 188,school_b_id: 160,tournament_id: 150,user_id: 1)

Tweet.create(title: "全国の高校野球に示した明徳野球",round: "準々決勝",text: "智辯学園相手に接戦を演じた明徳義塾だが、勝利まであと少しが届かなかった。9回の攻撃に関して馬淵監督は「米崎にスクイズをさせる選択肢はありました。初球から打ったので、もしボールになったらスクイズも考えていました」と先制点同様の攻撃で、ダメ押しをすることも頭にあったという。本当に少しの差で勝利を手にすることは出来なかったが、馬淵監督は選手たちへこのようなメッセージを残す。「このチームで甲子園出る時に周りに比べれば体が大きくない。パワーもスピードもない中で、選抜と甲子園にも出場してくれた。心の底からよくやったといってやりたいです」選抜の時から馬淵監督が口々にしていたパワーとスピード。これ対抗し続け、選抜と夏の甲子園で熱戦を繰り広げた。馬淵監督のなかでもこの1年の功績は大きかったと感じている。",
             school_a_score: "2",school_b_score: "1",school_a_id: 181,school_b_id: 191,tournament_id: 150,user_id: 2)

Tweet.create(title: "「直球軸」ぶれなかった智辯学園・小畠が大活躍",round: "準決勝",text: "今日の試合、やはり智辯学園の右のエース・小畠の活躍がなければ、初の決勝進出というものはなかっただろう。「選抜の広島新庄戦をきっかけに好調が続いている」と小坂監督は評価しているが、ストレート系のボールを使ってピッチングを展開し続けていることが大きいだろう。昨秋の近畿大会をきっかけに現在のスタイルに行きついたそうだが、ストライクゾーンで勝負できることで、ストライク先行でピッチングできている。今日もストライク率は41.53%（118球中49球）という数字があり、小畠らしさが出ていた。特に変化球を活かすという意味でも日本航空戦に続き、軸となるストレートをしっかりと投げ込めていることで、自分有利なカウントでピッチングを展開しやすくなっていたことも大きい。",
             school_a_score: "3",school_b_score: "1",school_a_id: 181,school_b_id: 178,tournament_id: 150,user_id: 1)

Analysis.create(title: "神宮覇者",text: "投手陣が豊富なチームで神宮大会の優勝校 エースの西原の制球力に不安はあるものの投手力が良く、明治神宮大会でも星稜に投げ勝った事で選抜でもダークホースに上がりそう",
                attack:"3",defensive:"4",pitcher:"5",comprehensive:"4",expectations:"4",school_id: 2,tournament_id: 1,user_id: 3)
...
Analysis.create(title: "注目の投手陣",text: "中国チャンピオンの広島の名門。今年はレベルの高いピッチャーが３人いて、総合力も高く優勝候補だと思います。",
                attack:"4",defensive:"5",pitcher:"5",comprehensive:"5",expectations:"5",school_id: 22,tournament_id: 1,user_id: 2)

Analysis.create(title: "四国の古豪",text: "香川の名門高松商業。今年はコツコツネバネバのチームと言われています。得点力の高い打線にエースの香川のピッチングが噛み合えば強いチームです。",
                attack:"4",defensive:"4",pitcher:"4",comprehensive:"4",expectations:"4",school_id: 25,tournament_id: 1,user_id: 4)
...
Analysis.create(title: "相変わらずの堅守",text: "伝統の堅守の明徳。今年もピッチャーを中心として守りが堅いです。エースの代木はなかなか打てないピッチャーです。課題はやはり打線か。",
                attack:"3",defensive:"5",pitcher:"4",comprehensive:"4",expectations:"4",school_id: 140,tournament_id: 117,user_id: 3)
...
Analysis.create(title: "近畿チャンピオン",text: "強打で近畿チャンピオンとなった名門。決勝では大阪桐蔭を下し総合力の高いチームです。",
                attack:"5",defensive:"4",pitcher:"3",comprehensive:"4",expectations:"5",school_id: 131,tournament_id: 117,user_id: 4)
...
Analysis.create(title: "強打で春初勝利を狙う",text: "看板の打線は本塁打を連発する派手さはないが、粘り強い好打者がそろう。昨秋の公式戦はチーム打率3割6分6厘、1試合平均10得点。足を絡めた積極的な攻めもあり、中国大会で準優勝した",
                attack:"4",defensive:"3",pitcher:"3",comprehensive:"3",expectations:"4",school_id: 106,tournament_id: 84,user_id: 2)
...
Analysis.create(title: "神宮覇者",text: "プロ注目の高橋を擁し神宮大会を制した。総合力が高く優勝候補です！",
                attack:"5",defensive:"5",pitcher:"5",comprehensive:"5",expectations:"5",school_id: 94,tournament_id: 84,user_id: 3)
...
Analysis.create(title: "再び強力打線で挑む",text: "去年の選抜で24得点で勝った試合は記憶に新しい。今年もその強打で挑みます！",
                attack:"4",defensive:"4",pitcher:"3",comprehensive:"4",expectations:"3",school_id: 92,tournament_id: 84,user_id: 4)
...
Analysis.create(title: "公立最強",text: "選抜ベスト４の実力校。公立勢の中では今大会最強だと思います。2年生エースの中森に注目です。",
                attack:"4",defensive:"4",pitcher:"4",comprehensive:"5",expectations:"5",school_id: 64,tournament_id: 34,user_id: 3)
...
Analysis.create(title: "北信越で敵なしの強打",text: "選抜は常総学院に初戦敗退だったが、ひと回り成長して甲子園に戻ってきた。強力打線は健在で春の北信越大会を制した。投手力も上がっており優勝候補の一角だと思う。",
                attack:"5",defensive:"4",pitcher:"4",comprehensive:"4",expectations:"4",school_id: 176,tournament_id: 150,user_id: 2)
...
Analysis.create(title: "強力打線で圧倒",text: "何と言っても三重大会で6戦100得点の打力が目立つ。校通算29本塁打の品川ら強打者が並ぶが「打撃を注目されるけど、守備からリズムを作るチーム」と4番でもある池田主将の見方は違う。実際、三重大会での失策はわずか2。宝田、品川の二遊間を中心に、堅守が攻撃につながったと自負している。",
                attack:"5",defensive:"4",pitcher:"3",comprehensive:"4",expectations:"4",school_id: 171,tournament_id: 150,user_id: 3)
...
Forecast.create(text: "二人の投手による継投、打線が看板というよく似たチームの対戦。大阪ｖｓ東京では例年大阪勢が意地を見せる展開が多いがこの試合では履正社エースの清水の投球がカギを握る。関東一打線にビックイニングを作らせないことが重要。試合展開としては当たっている井上が先陣を切り絶えずリードして展開する試合運びで逃げ切りを図りたい。",
                round: "準々決勝",probability: "70",win_school_id: 63,lose_school_id: 48,tournament_id: 34,user_id: 2)
...
Forecast.create(text: "夏の甲子園初登場の富島が２年連続出場で昨年のチームより力がある敦賀気比に挑戦する構図。ポイントは富島エースの黒木の出来。笠島・黒田の投手力が安定する敦賀気比に対して黒木がライバル以上に好投すれば総合力の差は少なくなる。富島は注目のトップバッター松浦が攻撃面でチームを引っ張る活躍を見せたい。富島は、去年の選抜では星稜の奥川投手とも対戦しているが今回も同じ北陸勢との対戦となり借りを返し甲子園初勝利を挙げられるか。",
                round: "1回戦",probability: "80",win_school_id: 60,lose_school_id: 81,tournament_id: 34,user_id: 4)
...
Forecast.create(text: "初戦ともにエースが粘りの投球を見せ打線がしぶとく得点を挙げたチーム同士の対戦。初戦の怪我で登板が難しい岡山学芸館・丹羽投手。中川投手が一人で作新学院打線を抑えられるかが焦点。直球が１４０キロを超え強打の広島商を８安打５失点に抑えたがこの試合も同じぐらいの失点は覚悟しなければならないだろう。岡山学芸館打線も初戦１０安打を放ち特に上位が当たっているのが頼もしい。作新学院は林ー三宅の継投が考えられるが序盤でリードを許さなければ自分たちのペースで試合を運べそう。",
                round: "3回戦",probability: "90",win_school_id: 44,lose_school_id: 67,tournament_id: 34,user_id: 2)
...
Forecast.create(text: "ここまで影山投手が好投して打線の振りが鋭い鶴岡東の勢いが目立つがそろそろどちらかの勢いが落ちると予想する。関東一は土屋投手が２回戦は完投し制球に難はあるが球に力のある谷投手が万全の調整が出来たことが心強い。打線の得点力は互角と見ているので投手力の差が試合結果に直結しそう。鶴岡東は池田投手に８回、出来れば９回にスイッチできればこれまでの２試合のような必勝態勢となる。関東一は中盤までに影山投手を降板させられるかがポイントとなる。",
                round: "3回戦",probability: "70",win_school_id: 48,lose_school_id: 40,tournament_id: 34,user_id: 3)
...
Forecast.create(text: "初戦２点、２回戦１点と打線が湿りっぱなしの東海大相模が福岡大大濠の好投手・毛利に対してどう得点していくかが見どころ。互いに２回戦は大苦戦したのでこの試合は波に乗った方が案外スルスル行く可能性がある。ポイントは福岡大大濠の先発投手。２回戦でやや調子が落ち始めた毛利が３試合目も先発で行くのか控え投手を起用するのか、いずれにしても中盤まで東海打線を眠ったままにしておけるかが大濠勝利のカギ。",
                round: "準々決勝",probability: "80",win_school_id: 125,lose_school_id: 143,tournament_id: 117,user_id: 2)
...
Forecast.create(text: "ここまで不安視された「投手」で好調を維持する石川は「打」では若干不発気味。「投」では奥田投手の先発が予想されるのでこのゲームでは「打」で貢献したい。好調を維持する４番の熊田もタイムリーが欲しい。明石商は疲れが見える中森投手を来田をはじめ打線で早めに援護できるかどうか。３点ほどの接戦になれば準々決勝同様勝機も出てくる。中森投手が早めに崩れるようだと大差もあり得る",
                round: "準決勝",probability: "60",win_school_id: 12,lose_school_id: 19,tournament_id: 1,user_id: 2)
...
Forecast.create(text: "浮橋投手を中心に投打にバランスの良い富岡西が東海王者で投打に中心の石川が引っ張る強豪・東邦に挑む一戦。ポイントは東邦の先発投手。昨年に続き投手力に不安を抱える東邦だが富岡西も四国大会では打線が当たっていたので４，５点の取り合いになれば浮橋投手の踏ん張り次第で好ゲームになりそう。東邦は石川がバットでチームを引っ張りたい。",
                round: "1回戦",probability: "90",win_school_id: 12,lose_school_id: 32,tournament_id: 1,user_id: 3)
...
Forecast.create(text: "習志野は山内、市和歌山は岩本といずれも左腕投手の先発を予想。初戦は両投手とも好投を見せたがこの試合も先発投手の出来が大きく影響しそう。打線は市和歌山の方が当たっているがリリーフ投手は習志野に分がある。習志野は根本選手の復帰が無ければ苦しいが３点を争う接戦が期待される。",
                round: "準々決勝",probability: "80",win_school_id: 7,lose_school_id: 20,tournament_id: 1,user_id: 2)

Forecast.create(text: "明徳義塾が鳥取城北に守り勝つと予想。鳥取城北としては得意の打撃戦に持ち込みたいところ。",
                round: "1回戦",probability: "80",win_school_id: 108,lose_school_id: 106,tournament_id: 84,user_id: 3)
...
Forecast.create(text: "東西の名門対決。互角だが近年の大阪桐蔭の活躍を買います！",
                round: "1回戦",probability: "60",win_school_id: 100,lose_school_id: 91,tournament_id: 84,user_id: 2)

Forecast.create(text: "強打＋プロ注目の小林がいる智弁和歌山がリードする。尽誠学園としてはあまり失点したくない。",
                round: "1回戦",probability: "80",win_school_id: 104,lose_school_id: 109,tournament_id: 84,user_id: 4)

Forecast.create(text: "2019夏決勝の再現。履正社は今年もチーム力が高く優勝候補に上がっていただろう。星稜も北信越決勝で19得点で強打のチーム。レベルの高い戦いとなるでしょう。",
                round: "1回戦",probability: "70",win_school_id: 101,lose_school_id: 97,tournament_id: 84,user_id: 2)

Forecast.create(text: "いずれも昨秋の県大会で優勝している実力校の対戦。両チームとも打撃を売りにしており投手陣の踏ん張りが試合を分けそう。ポイントはやや非力に見える米子東投手陣の出来。エースの舩木が中盤まで日大山形打線を３点までに抑えられるか。日大山形投手陣も継投策で来ると思うが米子東としては先制点を挙げ早めに２番手投手を引きずり出したいところだ。",
                round: "1回戦",probability: "80",win_school_id: 156,lose_school_id: 185,tournament_id: 150,user_id: 3)

Forecast.create(text: "昨秋・今春の佐賀県大会を制している大本命だった東明館が初めての甲子園に挑戦する。投打にオーソドックスなチームだが生命線は打たれ強いエースの今村。春の関東大会で東海大相模を下している日本航空打線に、安打は打たれても大量失点を許さなければ接戦に持ち込める。日本航空としては得意の長打で得点しヴェデルナ・小沢を中心とした継投でリードを保ちながら試合を進めたい。",
                round: "1回戦",probability: "70",win_school_id: 167,lose_school_id: 193,tournament_id: 150,user_id: 1)

Forecast.create(text: "初戦ロースコアの僅差で辛勝した同士の対決。二松学舎大付・秋山投手は途中ピンチもあったが４安打完封。ピンチではギアを上げさすがの投球を見せた。京都国際・森下投手も選抜時より球威が増しこちらも４安打完封。両校投手が対戦するこの試合もロースコアの投手戦が想定される。注目は左腕・秋山投手と京都国際の左打者。左打者が５，６人並ぶ打線がどういう攻撃をするかが試合の行方を左右しそうだ。",
                round: "3回戦",probability: "60",win_school_id: 164,lose_school_id: 178,tournament_id: 150,user_id: 2)

Forecast.create(text: "近畿大会でよく見る顔合わせ。総合力で大阪桐蔭が上回る。大阪桐蔭は初戦雨中の打撃戦だったが松浦投手は中盤までは相手の強打を良く抑えた。この試合まで休養日も十分取れている。一方、大阪桐蔭打線は３本のホームランを放ち１０安打と好調を維持している。近江は山田ー岩佐の継投で初戦２失点だったがこの試合は５失点以内に抑えないと勝機は見いだせない。中盤まで二点差以内で付いていきたい。",
                round: "2回戦",probability: "70",win_school_id: 179,lose_school_id: 177,tournament_id: 150,user_id: 1)

Forecast.create(text: "初戦ピンチはありながらも選抜準優勝校の明豊を完封した深沢投手ｖｓ長崎商打線という構図。総合力では専大松戸が１枚上手だと思うが、長崎商としては数少ないであろうチャンスで２，３点まとまった得点が欲しい。専大松戸も打線は選抜時に比べて得点力が増しているので長崎商は継投時期を見極め城戸ー田村で３失点以内に抑えたい。",
                round: "2回戦",probability: "80",win_school_id: 163,lose_school_id: 194,tournament_id: 150,user_id: 1)
...
Map.create(text: "上田市（うえだし）は、長野県の東部（東信地方）にある市です。東信地方および上田地域の中心都市で、長野県内では長野市、松本市に次ぐ3番目の規模の都市です。上田城、別所温泉などがあります。",
           address: "上田市",latitude: 36.4019,longitude: 138.249,school_id: 130,tournament_id: 117,user_id: 3)
...
Map.create(text: "鳥取県の西部に位置し、山陰最大級の商業都市であり「山陰の大阪」とも称されます。8月には「がいな祭り」が開催され、がいな万灯、がいな太鼓などで賑わいます。夏は全国的にも暑いほうで、冬は豪雪地帯のため雪が積もり少し不便です。",
           address: "米子市",latitude: 35.4281,longitude: 133.331,school_id: 69,tournament_id: 34,user_id: 2)